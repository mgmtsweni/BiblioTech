...
SubmitButton = Button(adminWindow, text='submite', font=('Arial Sans', 8, 'bold'), fg='white', cursor='hand2',
                      bg='brown1', height=5, width=30, activebackground='brown1', activeforeground='white', command=database)
